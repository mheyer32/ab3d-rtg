...
OrderZones:		move.l	ListOfGraphRooms,a0		; a0=list of rooms to draw.
...
dontorder:		move.l	#OrderTab,a5
				move.w	4(a5),d0
				lea		(a5,d0.w*8),a5

				move.l	#FinalOrder,a0
showorder:		move.w	2(a5),(a0)+
				move.w	4(a5),d0
				blt.s	doneorder
				move.l	#OrderTab,a5
				lea		(a5,d0.w*8),a5
...
InsertList		move.l	d7,-(a7)
				moveq	#0,d7

InsertLoop		move.w	(a0)+,d0				; floor line
				blt		allinlist
				asl.w	#4,d0
; tst.l 8(a1,d0.w)
; beq.s InsertLoop
