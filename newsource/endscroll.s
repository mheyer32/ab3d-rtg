...
.fdup2			move.w	#15,d3
				move.w	#0,d2
.fdup			move.w	d0,ALLTEXT
				move.w	d2,ALLTEXTLOW
				add.w	#$111,d2

.wtframe:		btst	#5,$dff000+intreqr+1
				beq.s	.wtframe
...
.fdupwt
.wtframet:		btst	#5,$dff000+intreqr+1
				beq.s	.wtframet
				move.w	#$0020,$dff000+intreq
				dbra	d3,.fdupwt
...
.nostartscroll:
				...
				blt.s	.okitsaline
				jsr		DRAWLINEOFTEXT
.okitsaline:	move.l	OLDSCROLL,a0
				move.w	LASTLINE,d0
				move.l	TEXTSCRN,a1
				bsr		CLEARLINEOFTEXT
				tst.b	(a0)
