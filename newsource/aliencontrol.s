...
TOWARDSFRAME:
				move.l	#0,d0
				rts
RIGHTFRAME:		move.l	#1,d0
				rts
LEFTFRAME:		move.l	#3,d0
				rts
AWAYFRAME:		move.l	#2,d0
				rts
...
RunAround:		movem.l	d0/d1/d2/d3/a0/a1,-(a7)
...
.nofurther:		move.l	objroom,backroom
