...
.putitin:    move.w       d0,4(a0)
	...
	jsr          FindCloseRoom
	rts
.notyet:     move.w       FourthTimer(a0),d0
	asr.w        #4,d0
	add.w        #1,d0
	move.w       d0,d2
	...
	rts
.nosplatch   move.w       TempFrames,d0
...
.waitandsee: move.w       #30,FourthTimer(a0)
...
.notintop:   move.w       objyvel(a0),d2
	...
	neg.w        objyvel(a0)
	sub.l        #96*256,d3
.botnohit:   cmp.l        d1,d3
	bgt.s        .topnohit
	move.l       d1,d3
	neg.w        objyvel(a0)
.topnohit:   add.l        #48*256,d3
	asr.l        #7,d3
	move.w       d3,4(a0)
...
.oktoshoot:  move.w       12(a0),d2
	...
	move.l       #16,d0
	bra          .facing
.nofacing:   add.l        alframe,d0
.facing      add.l        #$40000,d0
	move.l       d0,8(a0)
...
.cantshoot:  move.w       TempFrames,d0
	sub.w        d0,SecTimer(a0)
	bge.s        .nohiss
