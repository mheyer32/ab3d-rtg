...
sometodraw:  move.w       itertab(pc,d1.w*4),d7
	swap         d0
...
scrdrawlop:  move.w       (a0)+,d0
	move.l       frompt,a3
	lea	0(a3,d0.w*2),a3	;adda.w       scrintocop(pc,d0.w*2),a3
...
***************************
	...
	bge.s        .brnotneg
	moveq        #0,d6
.brnotneg    cmp.w        #64,d6
	blt.s        .brnotpos
	move.w       #64,d6
.brnotpos    move.l       PaletteAddr,a2
	move.l       a2,a4
...
CurveDraw:   move.w       (a0)+,d0	     ; centre of rotation
...
curvecalc:   move.l       #databuffer,a1
	move.w       count(a2),d7
	subq         #1,d7
.findfirstinfront:
	move.l       (a1)+,d1
...
oneinfront1  tst.w        d3
	ble.s        oneinfront
; Bothinfront!

	nop

oneinfront   move.w       #16,d7
	move.w       #2,d6
...
nocliptop:	sub.w        d5,d6	        ; height to draw.
	ble.s        nostripq
	bra          gotoend
...
drawwallPACK0:
	;a5=source texture
	;d4=source Y
	;a2=texture colour->screen value table
	;a3=dest
	;d0=dest step
	;d6=length (height) of strip
...
cliptopusesimple
	move.w       VALAND,d7
	move.l	#96*2,d0	;move.w       #104*4,d0
	moveq        #0,d1
...
simplewallPACK0:
	...
	and.b        #31,d1
	move.w       (a2,d1.w*2),d3
.noread:     dbra         d6,simplewallPACK0
	rts
...
simplewallPACK1:
	...
	and.w        #31,d1
	move.w       (a2,d1.w*2),d3
.noread:     dbra         d6,simplewallPACK1
	rts
...
simplewallPACK2:
	...
	lsr.b        #2,d1
	move.w       (a2,d1.w*2),d3
.noread:     dbra         d6,simplewallPACK2
	rts
;---

gotoend:     add.l        timeslarge(pc,d5.w*4),a3
	move.w       d5,d4
