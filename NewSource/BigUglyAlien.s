...
.notdying:   move.l       #3*65536,deadframe
	move.l       #3*65536,8(a0)
...
.noscream    move.l       PLR1_Roompt,ToRoom
...
.noscream2:  tst.w        SecTimer(a0)
	blt.s        .canshoot
	move.w       TempFrames,d0
	sub.w        d0,SecTimer(a0)
	bra          .cantshoot
.canshoot:   move.l       NastyShotData,a5
	move.w       #19,d1
...
.cantshoot:  tst.b        GotThere
	...
	sub.w        d0,Energy
	bra          .carryonattack
.noteatyou:  move.l       PLR1_Roompt,ToRoom
	move.l       objroom,FromRoom
	move.w       newx,oldx
	move.w       newz,oldz
	move.w       PLR1_xoff,newx
