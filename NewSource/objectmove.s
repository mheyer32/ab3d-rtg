...
MoveObject:  move.l       #objroom,objroomback
	move.w       #200,QUITOUT
...
.moveing:    move.l       newy,wallhitheight
	move.l       objroom,a0
...
.yeshit:     move.l       d1,wallhitheight
...
.thisisawall2:
	...
	asl.w        d3,d2
	asl.w        d3,d4
.noshift     move.w       d2,a4
	move.w       d4,a6

.notomatoes: move.w       4(a2),d2
	sub.w        a4,d2
	sub.w        a6,d2
	move.w       d2,DX
	move.w       6(a2),d5
...
faraway:     move.w       speed,d3
	add.w        Range,d3
	cmp.w        d0,d3
	blt.s        .notoofast
	move.w       d0,d3
	st           GotThere
.notoofast:  sub.w        Range,d3
...
.nochange:   tst.w        d0
	...
	move.w       #3,d5
	move.w       #2048,d6
findanglop:  move.w       (a2,d2.w*2),d3
	move.w       (a3,d2.w*2),d4
	muls         d0,d4
	muls         d1,d3
	sub.l        d3,d4
...
CanItBeSeen: movem.l      d0-d7/a0-a6,-(a7)
	move.l       ToRoom,a1
	move.w       (a1),d0
	move.l       FromRoom,a0
	cmp.l        a0,a1
...
; we meet it.
	...
	muls         d7,d5
	divs         d4,d5
sameheight:  add.w        Viewery,d5	   ; height at which we cross wall
...
comparewithbottom:
	...
	bgt          outlist
madeit:      st           donessomething

	moveq        #0,d3
	move.w       8(a2),d3
	move.l       ZoneAdds,a3
	move.l       (a3,d3.w*4),a5
	add.l        LevelDataPtr,a5
...
foundpt:     movem.l      (a7)+,d0-a7/a0-a6
	rts

GetRand:     move.w       Rand1,d0
	add.w        #29,d0
	eor.w        #$5f37,d0
	neg.w        d0
	rol.w        #5,d0
...
Collision:   move.l       ObjectData,a0
	move.w       CollId,d0
	asl.w        #6,d0
...
ITSATEL:     move.l       ToZoneFloor(a2),floortemp
	...
	beq.s        .teleport
	rts
.teleport:   move.w       ToTelZone(a2),d0
	move.l       ZoneAdds,a2
	move.l       (a2,d0.w*4),a2
	add.l        LevelDataPtr,a2
	move.l       a2,objroom
...
foundclose:  move.w       d7,GraphicRoom(a0)
